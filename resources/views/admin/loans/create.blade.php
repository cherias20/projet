...
<div class="page-header">
    <h1><i class="fas fa-exchange-alt"></i> Créer un Emprunt</h1>
    <p class="page-subtitle">Enregistrer un nouvel emprunt de livre</p>
</div>
...
<div class="form-container">
    <form action="{{ route('admin.loans.store') }}" method="POST">
        ...
        <div class="form-section-title">
            <i class="fas fa-book-reader"></i> Informations de l'Emprunt
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="id_exemplaire" class="form-label">Sélectionner un Exemplaire <span style="color: #d32f2f;">*</span></label>
                    <select class="form-select @error('id_exemplaire') is-invalid @enderror" id="id_exemplaire" name="id_exemplaire" required>
                        ...
                        @foreach(\App\Models\Exemplaire::where('status', 'disponible')->get() as $exemplaire)
                            <option value="{{ $exemplaire->id_exemplaire }}" {{ old('id_exemplaire') == $exemplaire->id_exemplaire ? 'selected' : '' }}>
                                {{ $exemplaire->book->titre }} ({{ $exemplaire->code_exemplaire }})
                            </option>
                        @endforeach
                    </select>
                    @error('id_exemplaire')
        ...
        <div class="button-group">
            ...
            <a href="{{ route('admin.loans.index') }}" class="btn-back">
