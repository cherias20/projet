...
<div class="page-header">
    <h1><i class="fas fa-plus-circle"></i> Créer un Nouveau Livre</h1>
    <p class="page-subtitle">Ajoutez un nouveau livre à votre catalogue</p>
</div>
...
<div class="form-container">
    <form action="{{ route('admin.books.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('titre') is-invalid @enderror" id="titre" name="titre" value="{{ old('titre') }}" placeholder="Titre du livre" required>
                    @error('titre')
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('editeur') is-invalid @enderror" id="editeur" name="editeur" value="{{ old('editeur') }}" placeholder="Nom de l'éditeur" required>
                    @error('editeur')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('exemplaires') is-invalid @enderror" id="exemplaires" name="exemplaires" value="{{ old('exemplaires', 1) }}" min="1" placeholder="1">
                    @error('exemplaires')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control @error('resume') is-invalid @enderror" id="resume" name="resume" rows="4" placeholder="Entrez le résumé du livre...">{{ old('resume') }}</textarea>
            @error('resume')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            <label for="images" class="form-label">Image de Couverture</label>
            <div class="file-input-wrapper">
                ...
                <label for="images" class="file-input-label">
                    <i class="fas fa-cloud-upload-alt"></i> Sélectionner une image
                </label>
                ...
                <div class="checkbox-group">
                    @forelse($authors as $author)
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="author_{{ $author->id_auteur }}" name="authors[]" value="{{ $author->id_auteur }}" @if(in_array($author->id_auteur, old('authors', []))) checked @endif>
            ...
            <div class="col-md-6">
                ...
                <div class="checkbox-group">
                    @forelse($genres as $genre)
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="genre_{{ $genre->id_genre }}" name="genres[]" value="{{ $genre->id_genre }}" @if(in_array($genre->id_genre, old('genres', []))) checked @endif>
